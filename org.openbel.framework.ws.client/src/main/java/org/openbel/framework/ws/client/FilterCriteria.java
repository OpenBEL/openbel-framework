...
@XmlSeeAlso({ AnnotationFilterCriteria.class, FunctionTypeFilterCriteria.class,
        FunctionReturnTypeFilterCriteria.class,
        RelationshipTypeFilterCriteria.class, BelDocumentFilterCriteria.class,
        CitationFilterCriteria.class, NamespaceFilterCriteria.class })
