 ...
 *         &lt;element name="namespaceValues" type="{http://belframework.org/ws/schemas}NamespaceValue" maxOccurs="unbounded"/>
...
@XmlType(name = "", propOrder = { "handle", "namespaceValues", "filter",
        "dialect" })
@XmlRootElement(name = "FindKamNodesByNamespaceValuesRequest")
public class FindKamNodesByNamespaceValuesRequest {

    @XmlElement(required = true)
    protected KamHandle handle;
    @XmlElement(required = true)
    protected List<NamespaceValue> namespaceValues;
     ...
     * 
     * @param value allowed object is {@link KamHandle }
     * 
     */
     ...
     * <CODE>set</CODE> method for the namespaceValues property.
     * 
     * <p>
    ...
    public List<NamespaceValue> getNamespaceValues() {
        if (namespaceValues == null) {
            namespaceValues = new ArrayList<NamespaceValue>();
        }
        return this.namespaceValues;
    }
     ...
     * 
     * @param value allowed object is {@link NodeFilter }
     * 
     */
