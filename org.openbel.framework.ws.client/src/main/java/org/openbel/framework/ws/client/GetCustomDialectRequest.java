...
@XmlType(name = "", propOrder = { "kam", "geneNamespaces", "bpNamespaces",
        "chemNamespaces", "syntax", "hideNamespacePrefixes" })
...
public class GetCustomDialectRequest {
     ...
     * <CODE>set</CODE> method for the geneNamespaces property.
     * 
     * <p>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the bpNamespaces property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the chemNamespaces property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * 
     * @return possible object is {@link BelSyntax }
     * 
     */
     ...
     * 
     * @param value allowed object is {@link BelSyntax }
     * 
     */
