 ...
 *         &lt;element name="filter" type="{http://belframework.org/ws/schemas}EdgeFilter"/>
...
@XmlType(name = "", propOrder = { "handle", "filter", "dialect" })
@XmlRootElement(name = "FindKamEdgesRequest")
public class FindKamEdgesRequest {
     ...
     * 
     * @param value allowed object is {@link EdgeFilter }
     * 
     */
