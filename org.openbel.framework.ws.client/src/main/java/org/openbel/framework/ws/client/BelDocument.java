 ...
 * 
 * <p>
 * Java class for BelDocument complex type.
 * 
 * <p>
...
@XmlType(name = "BelDocument", propOrder = { "id", "name", "description",
        "version", "copyright", "disclaimer", "contactInfo", "licenseInfo",
        "authors", "annotationTypes", "namespaces" })
public class BelDocument {
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the annotationTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the namespaces property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
