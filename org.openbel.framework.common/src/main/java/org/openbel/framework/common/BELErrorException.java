...
/**
 * A class of BEL user-facing exceptions considered errors. Recovery from BEL
 * error exceptions is generally considered possible.
 */
public abstract class BELErrorException extends UserFacingException {
     ...
     */
    public BELErrorException(String name, String msg) {
        super(name, msg);
    }
     ...
     */
    public BELErrorException(String name, String msg, Throwable cause) {
