 ...
 */
public class CitationCommentAnnotationDefinition extends
    ...
    public CitationCommentAnnotationDefinition() {
        super(ANNOTATION_DEFINITION_ID, REGULAR_EXPRESSION,
                "The description of the citation resource.",
                "Use this annotation to link statements to a description of" +
                        "the citation.");
        setValue(".*");
    }
}
